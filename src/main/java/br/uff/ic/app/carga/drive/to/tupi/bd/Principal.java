package br.uff.ic.app.carga.drive.to.tupi.bd;
...
import br.uff.ic.app.carga.drive.to.tupi.bd.excecoes.TUmaiorQMeiaNoiteException;
...
//</editor-fold>
    ...
    private static Credential authorize() throws Exception {
        ...
        GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(JSON_FACTORY,
                new InputStreamReader(Principal.class.getResourceAsStream("/client_secrets.json")));
